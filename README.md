...
[![版本](https://img.shields.io/badge/版本-3.2.1-blue.svg)](https://github.com/user/AlchAss)
...
| `Z` | 减速档位1 | 按住时将当前操作减速至1/10速度 |
| `X` | 减速档位2 | 按住时将当前操作减速至1/100速度 |
| `右键` | 定量操作 | 右键风箱设定热量，右键研杵设定研磨度 |
